...
python3 /Users/iwanhidding/PycharmProjects/Internship-Helsinki/Cravat_put.py "$inputfile" > jobid.txt
...
do
  ...
  bedtools intersect -a output_annotation/non_coding.txt -b /Users/iwanhidding/Internship_Helsinki_2020_2021/installed_tools/ncER/ncER_perc_"${current_iteration}"_coordSorted.txt -wb >> /Users/iwanhidding/PycharmProjects/Internship-Helsinki/output_annotation/non_coding_chr_out.vcf
done

# add the column names from the other shit still to this
...
grep -v "^#" /Users/iwanhidding/PycharmProjects/Internship-Helsinki/output_annotation/*_pred.txt | cut -d ':' -f 2- > all_ann_variants.txt
cat header.txt all_ann_variants.txt | sort -k1,1V -k2,2n > /Users/iwanhidding/PycharmProjects/Internship-Helsinki/output_annotation/predicted_output.vcf
